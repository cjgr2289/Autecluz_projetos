...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($nombre) || $cantidad < 1 || empty($fecha)) {
...
<body>
    ...
    <div class="container">
        <div class="page-header">
            <h1>Editar Item</h1>
            <a href="../proyectos/ver.php?id=<?php echo $proyecto_id; ?>" class="btn-secondary">Volver</a>
        </div>
            ...
            <form method="POST">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="unidad_medida" value="<?php echo htmlspecialchars($item['unidad_medida'] ?? ''); ?>">
                    </div>
                </div>
                <div class="form-group">
